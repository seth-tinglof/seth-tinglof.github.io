var Layout = function () {
    ...
    var handleNav = function() {
        var uri = new URL(document.location)
        $(".navbar a.nav-item-child").each(function(idx, link) {
            var check = new URL(link.href)
            if (check.pathname == uri.pathname) {
                link.href = check.hash;
                if (uri.hash == check.hash || (!uri.hash && check.hash == '#body')) {
